 ...
 *
 */
public class MultipartUtilitySprawdzenie {
     ...
     * @throws IOException
     */
    public MultipartUtilitySprawdzenie(String requestURL, String charset)
            throws IOException {
    ...
    public String finish() throws IOException {
        ...
        if (status == HttpURLConnection.HTTP_OK) {
            String nazwaPliku = GlobalValue.sprawdzonyPlik.nazwa;
