...
public class WylogowanieAsync extends AsyncTask<String, String, String> {

    private Activity activity;

    public WylogowanieAsync(Activity activity)
    {
    ...
    private String sprawdzenieDanych(){
        ...
        if (wynik != null) {
            try {
                ...
                JSONObject objectjso = jsonObj.getJSONObject("logout");
